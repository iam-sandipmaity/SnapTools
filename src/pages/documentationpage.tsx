              ...
              <section id="faq" className="scroll-m-32">
                ...
                <div className="grid gap-4">
                  {[
                    ...
                    { q: "How is my privacy protected?", a: "Most tools run in your browser so files stay on your device. A few features call optional third-party APIs, and production analytics can be disabled with VITE_DISABLE_ANALYTICS=true." }
                  ].map((faq, i) => (
