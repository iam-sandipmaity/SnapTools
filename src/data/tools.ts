...
export const toolCategories: ToolCategory[] = [
  ...
  },
  {
    ...
    subTools: [
      { id: "percentage-calculator", title: "Percentage Calculator", description: "Calculate percentages online free. Find percentage of numbers, percentage increase, decrease, and more.", comingSoon: true },
      { id: "loan-calculator", title: "Loan Calculator", description: "Calculate loan payments online free. Compute monthly payments, interest, and amortization schedules.", comingSoon: true },
      { id: "mortgage-calculator", title: "Mortgage Calculator", description: "Calculate mortgage payments online free. Estimate monthly mortgage payments with taxes and insurance.", comingSoon: true },
      { id: "tip-calculator", title: "Tip Calculator", description: "Calculate tips online free. Split bills and calculate tip amounts for any percentage.", comingSoon: true },
      { id: "discount-calculator", title: "Discount Calculator", description: "Calculate discounts online free. Find final price after discount and savings amount.", comingSoon: true },
      { id: "roi-calculator", title: "ROI Calculator", description: "Calculate ROI online free. Measure return on investment and profitability.", comingSoon: true },
      { id: "tax-calculator", title: "Tax Calculator", description: "Calculate taxes online free. Estimate income tax and sales tax calculations.", comingSoon: true },
    ],
  },
  {
    id: "datetime",
    ...
    subTools: [
      { id: "date-difference", title: "Date Difference Calculator", description: "Calculate date difference online free. Find days, weeks, months, and years between dates.", comingSoon: true },
      { id: "date-formatter", title: "Date Formatter", description: "Format dates online free. Convert dates to different formats like ISO 8601, custom patterns.", comingSoon: true },
      { id: "business-days", title: "Business Days Calculator", description: "Calculate business days online free. Count working days between dates excluding weekends.", comingSoon: true },
      { id: "time-duration", title: "Time Duration Calculator", description: "Calculate time duration online free. Add or subtract hours, minutes, and seconds.", comingSoon: true },
      { id: "date-range", title: "Date Range Generator", description: "Generate date ranges online free. Create lists of dates for any period.", comingSoon: true },
      { id: "week-number", title: "Week Number Calculator", description: "Find week number online free. Get ISO week number for any date.", comingSoon: true },
    ],
  },
  {
    id: "media",
    ...
    subTools: [
      { id: "video-compressor", title: "Video Compressor", description: "Compress videos online free. Reduce video file size while maintaining quality.", comingSoon: true },
      { id: "audio-converter", title: "Audio Converter", description: "Convert audio formats online free. Convert between MP3, WAV, OGG, AAC, and more formats.", comingSoon: true },
      { id: "gif-maker", title: "GIF Maker", description: "Create GIFs online free. Make animated GIFs from videos or images.", comingSoon: true },
      { id: "audio-trimmer", title: "Audio Trimmer/Cutter", description: "Trim audio online free. Cut and crop audio files to any length.", comingSoon: true },
      { id: "video-to-audio", title: "Video to Audio Converter", description: "Extract audio from video online free. Convert video files to MP3, WAV, and other audio formats.", comingSoon: true },
      { id: "audio-joiner", title: "Audio Joiner", description: "Merge audio files online free. Combine multiple audio files into one.", comingSoon: true },
    ],
  },
  {
    id: "data",
    ...
    subTools: [
      { id: "excel-viewer", title: "Excel Viewer Online", description: "View Excel files online free. Open and read XLSX, XLS files in browser without Excel.", comingSoon: true },
      { id: "csv-editor", title: "CSV Editor", description: "Edit CSV files online free. View, edit, and modify CSV data in a table format.", comingSoon: true },
      { id: "fake-data-generator", title: "Fake Data Generator", description: "Generate fake data online free. Create test data for development and testing.", comingSoon: true },
      { id: "random-name", title: "Random Name Generator", description: "Generate random names online free. Create realistic fake names for testing.", comingSoon: true },
      { id: "random-address", title: "Random Address Generator", description: "Generate random addresses online free. Create fake addresses for testing purposes.", comingSoon: true },
      { id: "csv-json", title: "CSV to JSON / JSON to CSV", description: "Convert CSV to JSON and JSON to CSV online free. Fast and accurate data converter.", comingSoon: true },
    ],
  },
  {
    id: "link",
    ...
    subTools: [
      { id: "url-shortener", title: "URL Shortener", description: "Shorten URLs online free. Create short links for social media and marketing.", comingSoon: true },
      { id: "link-preview", title: "Link Preview Generator", description: "Preview links online free. Generate link previews with Open Graph metadata.", comingSoon: true },
      { id: "url-parser", title: "URL Parser & Builder", description: "Parse URLs online free. Extract and build URL components, query parameters, and fragments.", comingSoon: true },
      { id: "qr-url", title: "URL to QR Code", description: "Convert URL to QR code online free. Generate scannable QR codes from links.", comingSoon: true },
    ],
  },
  {
    id: "random",
    ...
    subTools: [
      { id: "random-number", title: "Random Number Generator", description: "Generate random numbers online free. Create random integers within custom ranges.", comingSoon: true },
      { id: "dice-roller", title: "Dice Roller", description: "Roll dice online free. Roll virtual dice with customizable sides for games.", comingSoon: true },
      { id: "coin-flipper", title: "Coin Flipper", description: "Flip a coin online free. Virtual coin toss for heads or tails decisions.", comingSoon: true },
      { id: "yes-no", title: "Yes/No Decision Maker", description: "Make decisions online free. Get random yes or no answers for quick decisions.", comingSoon: true },
      { id: "random-picker", title: "Random Picker", description: "Pick random items online free. Select random choices from a list.", comingSoon: true },
      { id: "random-color", title: "Random Color Generator", description: "Generate random colors online free. Create random hex, RGB, and HSL colors.", comingSoon: true },
    ],
  },
  {
    id: "health",
    ...
    subTools: [
      { id: "calorie-calculator", title: "Calorie Calculator", description: "Calculate calories online free. Estimate daily caloric needs based on activity level.", comingSoon: true },
      { id: "macro-calculator", title: "Macro Calculator", description: "Calculate macros online free. Find optimal protein, carbs, and fat intake for your goals.", comingSoon: true },
      { id: "water-intake", title: "Water Intake Calculator", description: "Calculate water intake online free. Find how much water you should drink daily.", comingSoon: true },
      { id: "body-fat", title: "Body Fat Percentage Calculator", description: "Calculate body fat percentage online free. Estimate body fat using various methods.", comingSoon: true },
      { id: "ideal-weight", title: "Ideal Weight Calculator", description: "Calculate ideal weight online free. Find healthy weight range based on height and age.", comingSoon: true },
      { id: "tdee-calculator", title: "TDEE Calculator", description: "Calculate TDEE online free. Find total daily energy expenditure for weight management.", comingSoon: true },
    ],
  },
  {
    id: "business",
    ...
    subTools: [
      { id: "signature-generator", title: "Email Signature Generator", description: "Create email signatures online free. Design professional email signatures with contact info.", comingSoon: true },
      { id: "resume-builder", title: "Resume Builder", description: "Build resume online free. Create professional resumes with templates.", comingSoon: true },
      { id: "invoice-generator", title: "Invoice Generator", description: "Generate invoices online free. Create professional invoices for clients.", comingSoon: true },
      { id: "receipt-generator", title: "Receipt Maker", description: "Create receipts online free. Generate professional receipts for payments.", comingSoon: true },
      { id: "business-card", title: "Business Card Generator", description: "Design business cards online free. Create professional business card designs.", comingSoon: true },
      { id: "logo-maker", title: "Logo Maker", description: "Create logos online free. Design simple text-based logos for brands.", comingSoon: true },
      { id: "meme-generator", title: "Meme Generator", description: "Create memes online free. Generate funny memes with custom text and images.", comingSoon: true },
    ],
  },
  {
    id: "ai",
