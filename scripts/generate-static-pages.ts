...
const staticRoutes = [
  ...
  {
    path: "/tools",
    title: "All Tools - 100+ Free Online Tools | SnapTools",
    description:
      "Browse all 100+ free online tools. PDF merger, image compressor, QR generator, calculators, converters & more. No registration, no ads. Fast, secure & privacy-focused.",
    image: `${BASE_URL}/og-image.jpg`,
  },
  {
    path: "/about",
    title: "About SnapTools - Free Online Tools Platform",
    description:
      "Learn about SnapTools - a free, privacy-focused platform offering 100+ online tools. No registration required. Built for everyone.",
    image: `${BASE_URL}/og-image.jpg`,
  },
  {
    path: "/contact",
    title: "Contact SnapTools - Get in Touch",
    description:
      "Contact SnapTools for support, feedback, or partnership inquiries. We respond to all messages within 24 hours.",
    image: `${BASE_URL}/og-image.jpg`,
  },
  {
    path: "/privacy",
    title: "Privacy Policy | SnapTools",
    description:
      "Read SnapTools privacy policy. Your data is safe with us - all processing happens in your browser. No tracking, no storage.",
    image: `${BASE_URL}/og-image.jpg`,
  },
  {
    path: "/terms",
    title: "Terms of Service | SnapTools",
    description:
      "Read the terms of service for SnapTools free online tools. Simple, fair terms for using our 100+ free tools.",
    image: `${BASE_URL}/og-image.jpg`,
  },
  {
    path: "/features",
    title: "Features - 100+ Free Online Tools | SnapTools",
    description:
      "Discover SnapTools features: PDF tools, image tools, converters, calculators & more. All free, no registration, privacy-focused.",
    image: `${BASE_URL}/og-image.jpg`,
  },
  {
    path: "/pricing",
    title: "Pricing - 100% Free | SnapTools",
    description:
      "SnapTools is 100% free! No premium plans, no hidden fees. Access all 100+ tools completely free forever.",
    image: `${BASE_URL}/og-image.jpg`,
  },
  {
    path: "/donate",
    title: "Support SnapTools - Donate",
    description:
      "Support SnapTools development. Help us keep all tools free and add more features. Every contribution matters!",
    image: `${BASE_URL}/og-image.jpg`,
  },
  {
    path: "/documentation",
    title: "Documentation | SnapTools",
    description:
      "SnapTools documentation. Learn how to use our free online tools effectively. Guides for PDF, image, and other tools.",
    image: `${BASE_URL}/og-image.jpg`,
  },
  {
    path: "/changelog",
...
function getMetaTagsForRoute(pathname: string): MetaTags {
  ...
  const staticRoute = staticRoutes.find((r) => r.path === pathname);
  if (staticRoute) {
    return {
