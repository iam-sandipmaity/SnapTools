                                            ...
                                            children: [
                                                {
                                                    type: 'div',
                                                    props: {
                                                        style: { fontSize: '26px', fontWeight: '800', color: 'rgba(255,255,255,0.9)', letterSpacing: '-0.02em' },
                                                        children: 'Snap',
                                                    },
                                                },
                                                {
                                                    type: 'div',
                                                    props: {
                                                        style: { fontSize: '26px', fontWeight: '800', color: gradient.from, letterSpacing: '-0.02em' },
                                                        children: 'Tools',
                                                    },
                                                },
                                                {
                                                    type: 'div',
                                                    props: {
                                                        style: { marginLeft: '10px', fontSize: '18px', color: 'rgba(255,255,255,0.2)', fontWeight: '400' },
